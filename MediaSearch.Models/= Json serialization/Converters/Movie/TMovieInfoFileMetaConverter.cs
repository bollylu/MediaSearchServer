...
public class TMovieInfoFileMetaJsonConverter : JsonConverter<TMovieInfoFileMeta>, ILoggable {
  public ILogger Logger { get; set; } = GlobalSettings.LoggerPool.GetLogger<TMovieInfoFileMetaJsonConverter>();
