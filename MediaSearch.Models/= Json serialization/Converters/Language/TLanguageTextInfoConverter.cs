...
public class TLanguageTextInfoJsonConverter : JsonConverter<TLanguageTextInfo>, ILoggable {
  public ILogger Logger { get; set; } = GlobalSettings.LoggerPool.GetLogger<TLanguageTextInfoJsonConverter>();
