...
public abstract class AMediaSearchDataTableMemory<T> : IMSTable<T>, IMediaSearchLoggable<AMediaSearchDataTableMemory<T>> where T : IMedia {

  public IMediaSearchLogger<AMediaSearchDataTableMemory<T>> Logger { get; } = GlobalSettings.LoggerPool.GetLogger<AMediaSearchDataTableMemory<T>>();

  public IMSTableHeader<T> Header { get; } = new TMSTableHeader<T>();
