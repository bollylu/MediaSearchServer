...
public abstract class AMSTableHeader<RECORD> : IMSTableHeader<RECORD> where RECORD : IMSRecord {
  ...
  protected AMSTableHeader() {
    LastUpdate = DateTime.Now;
    MediaSource = TMediaSource.Create("", typeof(RECORD));
  }
  protected AMSTableHeader(IMSTableHeader<RECORD> header) {
    Name = header.Name;
