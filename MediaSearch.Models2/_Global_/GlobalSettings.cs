...
public static class GlobalSettings {
  ...
  public static ILogger GlobalLogger { get; set; } = new TConsoleLogger() { Name = nameof(GlobalSettings) };
  ...
  public static TAbout ExecutingAbout {
    get {
      return _ExecutingAbout ??= new TAbout(AppDomain.CurrentDomain.GetAssemblies().Single(a => a.GetName().Name == "MediaSearch.Models2"));
    }
  }
