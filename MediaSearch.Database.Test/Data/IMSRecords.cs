...
public static class IMSRecordSource {

  public static IMSRecord GetMovieRecord(string name, string description, int year) {
  ...
  public static IList<IMSRecord> GetMovieRecords() {
    List<IMSRecord> RetVal = new();
